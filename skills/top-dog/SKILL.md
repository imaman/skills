...
When asked to explain or unpack a finding, hand it to the originating dog (it still has the diff and its reasoning loaded) and ask it to:
- prefer snippets (annotated where useful) over prose, when the finding pins to code
- keep the writeup tight and direct
